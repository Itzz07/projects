<?php
	...
	while($row = $query->fetch_assoc()){
		$empid = $row['empid'];
		  ...
		  $net = $gross + $cashadvance - $total_deduction;

		$contents .= '
			<h2 align="center">CashCODE IT Solutions</h2>
