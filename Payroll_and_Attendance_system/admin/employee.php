...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#edit_email').val(response.email).html(response.email);
      $('#gender_val').val(response.gender).html(response.gender);
      $('#nationality_val').val(response.nationality).html(response.nationality);
      $('#marital_status_val').val(response.marital_status).html(response.marital_status);
      $('#qualification_val').val(response.qualification).html(response.qualification);
      $('#department_val').val(response.department).html(response.department);
